...
<div class="catalog_item_block">
    ...
    <div class="catalog_item_hover">
        ...
        <a class="btn_white" data-toggle="pkModal" data-target="#callbackModal" data-ajax="/ajax/form.php?form_id=<?=$arParams['ONECLICK_FORM_ID'];?>&field=PRODUCT&value=<?=$item['NAME'];?>" id="<?=$itemIds['BUY_ONE_CLICK']?>">Купить в 1 клик</a>
        <!--        <ul>-->
