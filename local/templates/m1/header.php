...
$main_color = Option::get($moduleID, 'BASE_COLOR_CUSTOM', "000000", SITE_ID);
$menu_color = Option::get($moduleID, 'MENU_COLOR', "000", SITE_ID);
...
<head>
    ...
    Asset::getInstance()->addJs(SITE_TEMPLATE_PATH."/js/mixitup.min.js");
    ?>
